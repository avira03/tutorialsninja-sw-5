...
//        Assert.assertEquals(expectedMessage, actualMessage);
        ...
        checkOutPage.enterPhoneNumber("04567832123");
        checkOutPage.enterAddress1("550,hermitage road");
        checkOutPage.enterCity("Coventry ");
        checkOutPage.enterPostCode("cv62ja");
        checkOutPage.selectCountry("United Kingdom");
        checkOutPage.selectRegion("West Midlands");
